...
//   Three buffers of depth 50 store up to three consecutive input rows.
...
// =============================================================================
reg [DIN_WIDTH-1:0]  conv_buffer0 [0:49];
reg [DIN_WIDTH-1:0]  conv_buffer1 [0:49];
reg [DIN_WIDTH-1:0]  conv_buffer2 [0:49];
